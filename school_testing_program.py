...
# 3. Сохранение в xlsx журнала отметок
...
# встроенная функция eval, которая анализирут переданную ей строку-выражение и выполняет ее, если это код,
# то есть она сразу же возвращает результат выполнения этой строки
# в pandas читает данные датафреймами(двухмерная структура данных, агалогичная таблице excel или sql)
...
# переменные для обозначения уровня доступа
STUDENTS_FILE_NAME = 'marks.xlsx'
ADMIN_ACCESS = 'ADMIN_ACCESS'
STUDENT_ACCESS = 'STUDENT_ACCESS'
INVALID_CREDENTIALS = 'INVALID_CREDENTIALS'

# создаем словарь с логинами и паролями зарегестрированных пользователей
logins = {
...
# создаем функцию, ктороая запускает программу
def run_study_programme():
    load_students()
...
# создаем функцию для проверки регистрации
...
# создаем функцию для генерации тестов
...
# создаем функцию, которая запускает тест
...
# создаем функцию для сохранения учеников и отметок
def save_data():
...
# пишем функцию, которая предлагает выбрать дальнейшее действие (выбрать из меню)
...
# создаем функцию, которая загружает историию отметок
def load_students():
...
# создаем функцию, которая отображает все отметки ученика
...
# создаем функцию, которая отображает средний балл по ученику и средний балл по школе
def show_average_info():
    ...
    to_print += f'Средний балл по школе {round(by_school_marks_sum / by_school_marks_count, 2)}, всего {by_school_marks_count} отметок'
    print(to_print)
